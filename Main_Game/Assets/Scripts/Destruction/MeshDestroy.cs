...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh( float a_DespawnTime )
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            parts[i].MakeGameobject(this, a_DespawnTime );
            Rigidbody rigidbody = parts[i].GameObject.GetComponent<Rigidbody>();
            rigidbody.AddForceAtPosition(parts[i].Bounds.center * ExplodeForce, transform.position );
        }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original, float a_DespawnTime )
        {
            ...
            Destroy( GameObject, a_DespawnTime );
        }
    }
}